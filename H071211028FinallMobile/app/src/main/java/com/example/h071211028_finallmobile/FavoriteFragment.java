...
import com.example.h071211028_finallmobile.adapter.FavoriteAdapter;
...
public class FavoriteFragment extends Fragment implements OnItemClick, SearchView.OnQueryTextListener{
    ...
    private void loadData() {
        tvNotFound.setVisibility(View.INVISIBLE);
        database.favoriteDao().getAll().observe(getViewLifecycleOwner(), new Observer<List<Favorite>>() {
            @Override
